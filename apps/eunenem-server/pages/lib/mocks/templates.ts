...
export const TEMPLATES: Template[] = [
  ...
  {
    id: "aviao-nas-nuvens",
    label: "avião nas nuvens",
    emoji: "✈️",
    img: "/public/templates/aviao-nas-nuvens.png",
    suggestedPalette: "azul",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.1, bottom: 0.06, left: 0.06, right: 0.06 },
    align: "center",
    scrim: "none",
    forEvents: ["cha-bebe", "aniversario", "cha-revelacao"],
  },
  {
    ...
    label: "balão dourado",
    emoji: "🎈",
    img: "/public/templates/balao-dourado.png",
    suggestedPalette: "butter",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.5, bottom: 0.06, left: 0.06, right: 0.06 },
    align: "center",
  ...
  },
  {
    ...
    label: "balões no céu",
    emoji: "🎈",
    img: "/public/templates/baloes-no-ceu.png",
    suggestedPalette: "coral",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.5, bottom: 0.06, left: 0.06, right: 0.06 },
    align: "center",
  ...
  {
    id: "bandeirinhas-ursinho",
    label: "bandeirinhas ursinho",
    emoji: "🧸",
    img: "/public/templates/bandeirinhas-ursinho.png",
    suggestedPalette: "cream",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.6, bottom: 0.42, left: 0.1, right: 0.1 },
    align: "center",
    scrim: "none",
    forEvents: ["cha-bebe", "cha-fraldas", "cha-revelacao"],
  },
  {
    id: "bichinhos-do-bosque",
    label: "bichinhos do bosque",
    emoji: "🦊",
    img: "/public/templates/bichinhos-do-bosque.png",
    suggestedPalette: "cream",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.08, bottom: 0.08, left: 0.35, right: 0.46 },
    align: "left",
    scrim: "soft",
    forEvents: ["cha-bebe", "aniversario"],
  },
  {
    id: "bola-na-rede",
    label: "bola na rede",
    emoji: "⚽",
    img: "/public/templates/bola-na-rede.png",
    suggestedPalette: "lime",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.6, bottom: 0.42, left: 0.1, right: 0.1 },
    align: "center",
    scrim: "none",
    forEvents: ["aniversario", "cha-bebe"],
  },
  {
    id: "borboleta-encantada",
    label: "borboleta encantada",
    emoji: "🦋",
    img: "/public/templates/borboleta-encantada.png",
    suggestedPalette: "lilas",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.2, bottom: 0.2, left: 0.08, right: 0.08 },
    align: "center",
  ...
  },
  {
    ...
    emoji: "⚽",
    img: "/public/templates/campo-de-futebol.png",
    suggestedPalette: "lime",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.3, bottom: 0.42, left: 0.1, right: 0.1 },
    align: "center",
  ...
  {
    id: "coelhinho-e-bebe",
    label: "coelhinho e bebê",
    emoji: "🐰",
    img: "/public/templates/coelhinho-e-bebe.png",
    suggestedPalette: "coral",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.3, bottom: 0.42, left: 0.1, right: 0.1 },
    align: "center",
  ...
  {
    id: "dinossauro-aviador",
    label: "dinossauro aviador",
    emoji: "🦕",
    img: "/public/templates/dinossauro-aviador.png",
    suggestedPalette: "azul",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.7, bottom: 0.42, left: 0.1, right: 0.1 },
    align: "center",
    scrim: "none",
    forEvents: ["cha-bebe", "aniversario", "cha-revelacao"],
  },
  {
    id: "dinossauro-azul",
    label: "dinossauro azul",
    emoji: "🦕",
    img: "/public/templates/dinossauro-azul.png",
    suggestedPalette: "azul",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.1, bottom: 0.42, left: 0.1, right: 0.1 },
    align: "center",
  ...
  },
  {
    ...
    label: "dormitório",
    emoji: "🛏",
    img: "/public/templates/dormitorio.png",
    suggestedPalette: "cream",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.48, bottom: 0.7, left: 0.1, right: 0.1 },
    align: "center",
    scrim: "none",
    forEvents: ["cha-bebe", "cha-fraldas"],
  },
  {
    id: "elefante-no-luar",
    label: "elefante no luar",
    emoji: "🐘",
    img: "/public/templates/elefante-no-luar.png",
    suggestedPalette: "lilas",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.4, bottom: 0.42, left: 0.1, right: 0.1 },
    align: "center",
    scrim: "none",
    forEvents: ["cha-bebe", "aniversario", "cha-revelacao"],
  },
  {
    ...
    label: "flor amarela",
    emoji: "🌼",
    img: "/public/templates/flor-amarela.png",
    suggestedPalette: "butter",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.2, bottom: 0.2, left: 0.08, right: 0.08 },
    align: "center",
  ...
  {
    id: "florestas-azuis-aquarela",
    label: "florestas azuis aquarela",
    emoji: "🌲",
    img: "/public/templates/florestas-azuis-aquarela.png",
    suggestedPalette: "azul",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.2, bottom: 0.2, left: 0.08, right: 0.08 },
    align: "center",
  ...
  },
  {
    ...
    label: "fundo marinho",
    emoji: "🐠",
    img: "/public/templates/fundo-marinho.png",
    suggestedPalette: "azul",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.3, bottom: 0.3, left: 0.1, right: 0.1 },
    align: "center",
    scrim: "none",
    forEvents: ["cha-bebe", "batizado"],
  },
  {
    id: "futebol-divertido",
    label: "futebol divertido",
    emoji: "⚽",
    img: "/public/templates/futebol-divertido.png",
    suggestedPalette: "lime",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.3, bottom: 0.42, left: 0.1, right: 0.1 },
    align: "center",
  ...
  {
    id: "girafa-estrelada",
    label: "girafa estrelada",
    emoji: "🦒",
    img: "/public/templates/girafa-estrelada.png",
    suggestedPalette: "coral",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.08, bottom: 0.08, left: 0.05, right: 0.46 },
    align: "left",
  ...
  {
    id: "patinho-laco-azul",
    label: "patinho laço azul",
    emoji: "🦆",
    img: "/public/templates/patinho-laco-azul.png",
    suggestedPalette: "azul",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.6, bottom: 0.42, left: 0.1, right: 0.1 },
    align: "center",
  ...
  {
    id: "patinho-xadrez",
    label: "patinho xadrez",
    emoji: "🦆",
    img: "/public/templates/patinho-xadrez.png",
    suggestedPalette: "azul",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.6, bottom: 0.42, left: 0.1, right: 0.1 },
    align: "center",
  ...
  {
    id: "quadra-de-futebol",
    label: "quadra de futebol",
    emoji: "⚽",
    img: "/public/templates/quadra-de-futebol.png",
    suggestedPalette: "lime",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.3, bottom: 0.42, left: 0.1, right: 0.1 },
    align: "center",
  ...
  {
    id: "roupinhas-delicada",
    label: "roupinhas delicada",
    emoji: "👶",
    img: "/public/templates/roupinhas-delicada.png",
    suggestedPalette: "coral",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.48, bottom: 0.06, left: 0.1, right: 0.1 },
    align: "center",
  ...
  {
    id: "urso-com-baloes",
    label: "urso com balões",
    emoji: "🧸",
    img: "/public/templates/urso-com-baloes.png",
    suggestedPalette: "cream",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.5, bottom: 0.42, left: 0.1, right: 0.4 },
    align: "center",
    scrim: "none",
    forEvents: ["cha-bebe", "cha-fraldas", "cha-revelacao"],
  },
  {
    id: "urso-nas-nuvens",
    label: "urso nas nuvens",
    emoji: "🧸",
    img: "/public/templates/urso-nas-nuvens.png",
    suggestedPalette: "cream",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.7, bottom: 0.42, left: 0.1, right: 0.1 },
    align: "center",
  ...
  {
    id: "xadrez-azul-suave",
    label: "xadrez azul suave",
    emoji: "♟",
    img: "/public/templates/xadrez-azul-suave.png",
    suggestedPalette: "azul",
    suggestedNameFont: "caveat",
    safeArea: { top: 0.48, bottom: 0.5, left: 0.1, right: 0.1 },
    align: "center",
    scrim: "none",
    forEvents: ["cha-bebe", "cha-fraldas"],
  },
