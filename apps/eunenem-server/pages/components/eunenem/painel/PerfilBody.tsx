...
import {
  ...
  type FotoSlot,
  PhotoSlot,
} from "@/components/eunenem/PhotoSlot";
...
// aperture-whxzg — SLOT_CONFIG / CropperModal / PhotoSlot moved to
// components/eunenem/PhotoSlot.tsx (shared with the public-page inline editor).
