...
import type { Conta, RegistrarContaUsuarioInput, Usuario } from '../domain/usuario.js';
import { PERMISSOES_PADRAO, RegistrarContaUsuarioInputSchema } from '../domain/usuario.js';
