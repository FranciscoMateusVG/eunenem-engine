...
import type { PagamentoProvider } from '../adapters/pagamento-provider.js';
...
import { PagamentoNaoEncontradoError } from '../errors/pagamento-nao-encontrado.error.js';
import { PagamentoTransicaoStatusInvalidaError } from '../errors/pagamento-transicao-status-invalida.error.js';
